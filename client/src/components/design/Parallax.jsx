...
export const Header = () => {
  return (
    <div className="max-w-7xl relative mx-auto py-20 md:py-40 px-4 w-full  left-0 top-0">
      ...
      Step into Innovation <br /> Where Your Ideas Begin
      </h1>
      <p className="max-w-2xl text-base md:text-xl mt-8 dark:text-neutral-200">
        Welcome to Afsify, your gateway to digital innovation and
        creativity. As a web developer, I specialize in turning your
        ideas into stunning realities. Dive into a world where imagination meets
        expertise, where we sculpt codes and pixels into bespoke digital
        masterpieces.
      </p>
    </div>
  );
